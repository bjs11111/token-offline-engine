...
public class AccelerationConfiguration extends SensorConfiguration {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2501384696143765066L;
	...
	public void setBleAdvertisingConditionOnMotion(int bleAdvertisingConditionOnMotion) {
	...
	public void setBleAdvertisingConditionOrientationAlarm(int bleAdvertisingConditionOrientationAlarm) {
	...
	public void setBleAdvertisingConditionMechanicalShock(int bleAdvertisingConditionMechanicalShock) {
	...
	public void setBleNotAdvertisingConditionOnMotion(int bleNotAdvertisingConditionOnMotion) {
	...
	public void setBleNotAdvertisingConditionOrientationAlarm(int bleNotAdvertisingConditionOrientationAlarm) {
	...
	public void setSensorMechanicalShockSemplingFrequency(double sensorMechanicalShockSemplingFrequency) {
	...
	public void setSensorMechanicalShockCutOffLowPassFrequency(double sensorMechanicalShockCutOffLowPassFrequency) {
	...
	public void setSensorMechanicalShockCutOffHighPassFrequency(double sensorMechanicalShockCutOffHighPassFrequency) {
	...
	public void setSensorMechanicalShockBroadcastEnabled(boolean sensorMechanicalShockBroadcastEnabled) {
	...
	public String toString() {
		...
		result += ", bleAdvertisingConditionOnMotion: " + bleAdvertisingConditionOnMotion;
		result += ", bleAdvertisingConditionOrientationAlarm: " + bleAdvertisingConditionOrientationAlarm;
		result += ", bleAdvertisingConditionMechanicalShock: " + bleAdvertisingConditionMechanicalShock;
		result += ", bleNotAdvertisingConditionOnMotion: " + bleNotAdvertisingConditionOnMotion;
		result += ", bleNotAdvertisingConditionOrientationAlarm: " + bleNotAdvertisingConditionOrientationAlarm;
		...
		result += ", sensorMechanicalShockSemplingFrequency: " + sensorMechanicalShockSemplingFrequency;
		result += ", sensorMechanicalShockCutOffLowPassFrequency: " + sensorMechanicalShockCutOffLowPassFrequency;
		result += ", sensorMechanicalShockCutOffHighPassFrequency: " + sensorMechanicalShockCutOffHighPassFrequency;
		result += ", sensorMechanicalShockEnabled: " + sensorMechanicalShockEnabled;
		result += ", sensorMechanicalShockBroadcastEnabled: " + sensorMechanicalShockBroadcastEnabled;
		return result;
	}
}